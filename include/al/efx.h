...
typedef void (CALL_METHOD *LPALGENEFFECTS)( ALsizei n, ALuint* effects );

/* Delete Effect objects. */
typedef void (CALL_METHOD *LPALDELETEEFFECTS)( ALsizei n, ALuint* effects );

/* Verify a handle is a valid Effect. */ 
typedef ALboolean (CALL_METHOD *LPALISEFFECT)( ALuint eid );

/* Set an integer parameter for an Effect object. */
typedef void (CALL_METHOD *LPALEFFECTI)( ALuint eid, ALenum param, ALint value); 
typedef void (CALL_METHOD *LPALEFFECTIV)( ALuint eid, ALenum param, ALint* values ); 

/* Set a floating point parameter for an Effect object. */
typedef void (CALL_METHOD *LPALEFFECTF)( ALuint eid, ALenum param, ALfloat value); 
typedef void (CALL_METHOD *LPALEFFECTFV)( ALuint eid, ALenum param, ALfloat* values ); 

/* Get an integer parameter for an Effect object. */
typedef void (CALL_METHOD *LPALGETEFFECTI)( ALuint eid, ALenum pname, ALint* value );
typedef void (CALL_METHOD *LPALGETEFFECTIV)( ALuint eid, ALenum pname, ALint* values );

/* Get a floating point parameter for an Effect object. */
typedef void (CALL_METHOD *LPALGETEFFECTF)( ALuint eid, ALenum pname, ALfloat* value );
typedef void (CALL_METHOD *LPALGETEFFECTFV)( ALuint eid, ALenum pname, ALfloat* values );
...
typedef void (CALL_METHOD *LPALGENFILTERS)( ALsizei n, ALuint* filters ); 

/* Delete Filter objects. */
typedef void (CALL_METHOD *LPALDELETEFILTERS)( ALsizei n, ALuint* filters );

/* Verify a handle is a valid Filter. */ 
typedef ALboolean (CALL_METHOD *LPALISFILTER)( ALuint fid );

/* Set an integer parameter for a Filter object. */
typedef void (CALL_METHOD *LPALFILTERI)( ALuint fid, ALenum param, ALint value ); 
typedef void (CALL_METHOD *LPALFILTERIV)( ALuint fid, ALenum param, ALint* values ); 

/* Set a floating point parameter for an Filter object. */
typedef void (CALL_METHOD *LPALFILTERF)( ALuint fid, ALenum param, ALfloat value); 
typedef void (CALL_METHOD *LPALFILTERFV)( ALuint fid, ALenum param, ALfloat* values ); 

/* Get an integer parameter for a Filter object. */
typedef void (CALL_METHOD *LPALGETFILTERI)( ALuint fid, ALenum pname, ALint* value );
typedef void (CALL_METHOD *LPALGETFILTERIV)( ALuint fid, ALenum pname, ALint* values );

/* Get a floating point parameter for a Filter object. */
typedef void (CALL_METHOD *LPALGETFILTERF)( ALuint fid, ALenum pname, ALfloat* value );
typedef void (CALL_METHOD *LPALGETFILTERFV)( ALuint fid, ALenum pname, ALfloat* values );
...
typedef void (CALL_METHOD *LPALGENAUXILIARYEFFECTSLOTS)( ALsizei n, ALuint* slots ); 

/* Delete Auxiliary Slot objects. */
typedef void (CALL_METHOD *LPALDELETEAUXILIARYEFFECTSLOTS)( ALsizei n, ALuint* slots );

/* Verify a handle is a valid Auxiliary Slot. */ 
typedef ALboolean (CALL_METHOD *LPALISAUXILIARYEFFECTSLOT)( ALuint slot ); 

/* Set an integer parameter for a Auxiliary Slot object. */
typedef void (CALL_METHOD *LPALAUXILIARYEFFECTSLOTI)( ALuint asid, ALenum param, ALint value ); 
typedef void (CALL_METHOD *LPALAUXILIARYEFFECTSLOTIV)( ALuint asid, ALenum param, ALint* values ); 

/* Set a floating point parameter for an Auxiliary Slot object. */
typedef void (CALL_METHOD *LPALAUXILIARYEFFECTSLOTF)( ALuint asid, ALenum param, ALfloat value ); 
typedef void (CALL_METHOD *LPALAUXILIARYEFFECTSLOTFV)( ALuint asid, ALenum param, ALfloat* values ); 

/* Get an integer parameter for a Auxiliary Slot object. */
typedef void (CALL_METHOD *LPALGETAUXILIARYEFFECTSLOTI)( ALuint asid, ALenum pname, ALint* value );
typedef void (CALL_METHOD *LPALGETAUXILIARYEFFECTSLOTIV)( ALuint asid, ALenum pname, ALint* values );

/* Get a floating point parameter for a Auxiliary Slot object. */
typedef void (CALL_METHOD *LPALGETAUXILIARYEFFECTSLOTF)( ALuint asid, ALenum pname, ALfloat* value );
typedef void (CALL_METHOD *LPALGETAUXILIARYEFFECTSLOTFV)( ALuint asid, ALenum pname, ALfloat* values );
